...
def feature_encoding_layer(xyz, feature, npoint, radius, sigma, K, mlp, is_training, bn_decay, weight_decay, scope, bn=True, use_xyz=True):
    ...
    with tf.variable_scope(scope) as sc:
        ...
        # print(grouped_xyz.shape, grouped_feature.shape, idx.shape) # e.g. (32, 1024, 32, 3) (32, 1024, 32, 6) (32, 1024, 32, 2)
        density = pointconv_util.kernel_density_estimation_ball(xyz, radius, sigma)
        # print('density: ', density.shape) # B-npoint-1
        ...
        # print('weight: ', weight.shape) # B-npoint-32-32
        ...
        # print('new_points: ', new_points.shape) # B-npoint-K-C

        new_points = tf.transpose(new_points, [0, 1, 3, 2])
        # print('new_points_transpose: ', new_points.shape) # B-npoint-C-K

        new_points = tf.matmul(new_points, weight)
        # print('new_points: ', new_points.shape) # B-npoint-C-K
        ...
        # print('new_points: ', new_points.shape) # B-npoint-1-C
...
def feature_decoding_layer(xyz1, xyz2, points1, points2, radius, sigma, K, mlp, is_training, bn_decay, weight_decay, scope, bn=True, use_xyz = True):
    ...
    with tf.variable_scope(scope) as sc:
        ...
        # print('interpolate_module: ', interpolated_points.shape) # B-npoint1-C

        #setup for deConv
        grouped_xyz, grouped_feature, idx = pointconv_util.grouping(interpolated_points, K, xyz1, xyz1, use_xyz=use_xyz)
        # print('grouped_xyz, grouped_feature, idx: ', grouped_xyz.shape, grouped_feature.shape, idx.shape) # e.g. (32, 64, 16, 3) (32, 64, 16, 515) (32, 64, 16, 2)
        ...
        new_points = tf.multiply(grouped_feature, density_scale)
        # print('new_points: ', new_points.shape) # (32, 64, 16, 515), (32, 256, 16, 515), (32, 1024, 16, 259), (32, 2048, 16, 131)

        new_points = tf.transpose(new_points, [0, 1, 3, 2])

        new_points = tf.matmul(new_points, weight)
        # print('new_points: ', new_points.shape) # (32, 64, 515, 32), (32, 256, 515, 32), (32, 1024, 259, 32), (32, 2048, 131, 32)
        ...
        # print('new_points: ', new_points.shape) # (32, 64, 1, 512), (32, 256, 1, 256), (32, 1024, 1, 256), (32, 2048, 1, 128)
        ...
        # print('new_points1: ', new_points1.shape) # (32, 64, 1, 768), (32, 256, 1, 384), (32, 1024, 1, 320), (32, 2048, 1, 131)
