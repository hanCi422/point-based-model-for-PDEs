...
parser.add_argument('--ntest', default=924, help='number of test [default: 924]')
...
TRAIN_DATASET = darcyflow_2d.Darcyflow_2d(root=DATA_PATH, r=5, nsample=NTRAIN)
print("start loading test data ...")
DATA_PATH = 'XXXXXX/piececonst_r421_N1024_smooth2.mat'
TEST_DATASET = darcyflow_2d.Darcyflow_2d_test(root=DATA_PATH, r=5, nsample=NTEST)
...
def test():
    ...
    # np.save('darcyflow_pointconv_record.npy', record)
...
def eval_and_record(sess, ops):
    ...
    print('total time after warming-up:', time.time()-t0)
